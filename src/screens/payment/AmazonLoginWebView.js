...
const unit = '<AmazonLoginWebView>';

export class AmazonLoginWebView extends Component {
    constructor(props) {
        super(props);
        this.state = {
            // USER
    ...
    render() {
        console.log("this.state in AmazonLoginWebView   ", this.state);
        console.log("this.props in AmazonLoginWebView   ", this.props);
        return (
            <View style={{ flex: 1 }}>
                {
...
export default connect(mapStateToProps)(AmazonLoginWebView);
