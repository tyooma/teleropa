...
const CategoryWithImageItem = ({image, text, id}) => {
    return(
        <TouchableOpacity style={styles.container} onPress={() => NavigationService.navigate('ProductsByCategory', {categoryID: id, categoryName: text})}>
