...
export function logIn(email, pass, route) {
  fetch("https://teleropa.de/WebiProgCommunicationApplicationUser/login", {
    ...
    .then((id) => {
      fetch(
        "https://teleropa.de/WebiProgCommunicationApplicationUser/getInfo",
        {
          method: "POST",
          headers: {
            Accept: "application/json",
...
export function resetPassword(email) {
  fetch(
    "https://teleropa.de/WebiProgCommunicationApplicationUser/resetPassword",
    {
      method: "POST",
      headers: {
        Accept: "application/json",
...
export function sendToken(token) {
  fetch(
    "https://teleropa.de//WebiProgCommunicationApplicationUser/changeUserPushNotificationToken",
    {
      method: "POST",
      headers: {
        Accept: "application/json",
